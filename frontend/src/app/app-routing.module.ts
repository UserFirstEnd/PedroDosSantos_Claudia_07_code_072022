...
const routes: Routes = [
  { path: 'admin', loadChildren: () => import('./social-network/admin/admin.module').then(m => m.AdminModule), canActivate: [AuthGuard, AuthGuardAdmin] }, //lazy loading pour charger adminmodule
